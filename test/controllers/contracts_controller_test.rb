...
class ContractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract" do
    assert_difference("Contract.count") do
      post contracts_url, params: { contract: { content: @contract.content, title: @contract.title, user_id: @contract.user_id } }
    end
  ...
  test "should update contract" do
    patch contract_url(@contract), params: { contract: { content: @contract.content, title: @contract.title, user_id: @contract.user_id } }
